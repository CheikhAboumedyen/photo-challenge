...
//   const photos = await getPhotosWithVotes(challengeId);
//   // Find which photo this user has voted for (if any)
//   let userVotedPhotoId: string | null = null;
//   if (userId) {
...
//       .from(schema.vote)
//       .leftJoin(schema.photo, eq(schema.photo.id, schema.vote.photoId))
//       .where(eq(schema.vote.userId, userId))
//       .limit(1);

//     userVotedPhotoId = existingVote[0]?.photoId ?? null;
//   }
