...
const highlights = [
  ...
  {
    icon: Users,
    label: "8k+ creators learning together",
  },
];
        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-balance text-4xl font-semibold leading-tight sm:text-5xl">
              Sign in to keep your portrait streak alive.
            </h1>
            <p className="text-lg text-muted">
              Access submissions, continue voting, and sync with the community
