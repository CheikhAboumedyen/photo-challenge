...
const perks = [
  { icon: ImageIcon, label: "Unlimited uploads per brief" },
  { icon: Frame, label: "Cloudinary-powered reviews" },
  { icon: Crown, label: "Leaderboard & badges" },
];
        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-balance text-4xl font-semibold leading-tight sm:text-5xl">
              Build your photo identity with the PixiVerse crew.
            </h1>
            <p className="text-lg text-muted">
              Join thousands of photographers who batch-create, vote fairly, and
              level up their craft every week.
            </p>
          </div>
